...
3. strict Composition 1.0 JSON is the style-neutral interchange model.
...
Composition 1.0 is the stable boundary for a future frontend, DAW extension, importer, alternate realizer, or MCP server. Such clients should reuse the model and checks instead of duplicating musical semantics.
